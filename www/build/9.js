...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__session_detail__ = __webpack_require__(293);
...
var SessionDetailPageModule = (function () {
    function SessionDetailPageModule() {
    }
    return SessionDetailPageModule;
}());
SessionDetailPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__session_detail__["a" /* SessionDetailPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__session_detail__["a" /* SessionDetailPage */]),
        ],
    })
...
var SessionDetailPage = (function () {
    function SessionDetailPage(navCtrl, navParams, dataProvider) {
...
SessionDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-session-detail',template:/*ion-inline-start:"/Users/songbyeongju/workspace/myProject/ionic_sample/src/pages/session-detail/session-detail.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title *ngIf="session">{{session.name}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <div *ngIf="session">\n    <h1>{{session.name}}</h1>\n    <h4 *ngFor="let speaker of session?.speakers">\n    {{speaker.name}}\n  </h4>\n    <p>\n      {{session.timeStart}} - {{session.timeEnd}}\n    </p>\n    <p>{{session.location}}</p>\n    <p>{{session.description}}</p>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/songbyeongju/workspace/myProject/ionic_sample/src/pages/session-detail/session-detail.html"*/,
    }),
